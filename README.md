...
- **Pueden sacar a alguien de un torneo** desde "Quiénes se anotaron" en el detalle del torneo (por ejemplo, si no pagó). Esa lista siempre muestra parejas, nunca nombres sueltos repetidos en dos lugares distintos: cada pareja anotada tiene una × para separarla (los dos quedan sin pareja, pero siguen inscriptos), y aparte, solo si hay alguien todavía sin con quién jugar, se lo muestra en un cartel "Todavía sin pareja" con su propia × para sacarlo del todo. Si una pareja ya jugó algún partido en el torneo, la app avisa y no la separa sola — hay que sacarle el resultado a mano primero, para no perder datos ya cargados.
- **Confirman las inscripciones** desde esa misma lista de "Quiénes se anotaron": cuando un jugador se anota solo desde la app queda como "Pendiente de confirmar" (con la categoría que eligió al lado, en un torneo que abarca varias) hasta que vos revisás que pagó (por WhatsApp, transferencia, efectivo, lo que uses) y tocás "Confirmar". Ahí recién pasa a "Confirmada". Si vos mismo inscribís a alguien a mano desde "Inscribir jugador manualmente", queda confirmada directo (ya la revisaste vos al cargarla). "Armar parejas automáticamente" ahora respeta la categoría de cada uno al emparejar, para no mezclar categorías distintas en un torneo que compite en varias a la vez.
