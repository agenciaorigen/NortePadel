...
- **Ranking por categoría**: en la pestaña Ranking, primero se elige Damas o Caballeros y recién ahí aparecen las pastillas de esas categorías (6ta, 5ta, etc.) — así entran todas, aunque haya muchas, sin que las tape el ancho de la pantalla. Cada jugador se ve con su foto al lado del nombre, mostrando el top 10 de esa categoría por defecto (con un botón "Ver ranking completo" si hay más de 10). Se actualiza solo al cargar cada resultado, incluso en las pantallas de otros jugadores en vivo. La misma separación Damas/Caballeros se usa para elegir categoría en el perfil del jugador, al crear un torneo y en el panel de administrador.
