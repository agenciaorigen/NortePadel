...
create or replace function partidos_publicos(p_torneo_id uuid) returns table (
  ...
  -- nombre/apellido de cada uno de los 4 jugadores por separado (además del
  -- "pareja1_nombre" ya concatenado, que se sigue usando en otras vistas) —
  -- lo pide la tarjeta de Zona/Ronda para mostrar apellido en negrita y
  -- nombre chico debajo, en vez de todo junto en una sola línea
  j1a_nombre text, j1a_apellido text, j1b_nombre text, j1b_apellido text,
  j2a_nombre text, j2a_apellido text, j2b_nombre text, j2b_apellido text,
  ...
  select pa.id, pa.ronda, pa.categoria, pa.grupo, pa.horario, pa.estado, pa.sets,
    ...
    j1a.nombre, j1a.apellido, j1b.nombre, j1b.apellido,
    j2a.nombre, j2a.apellido, j2b.nombre, j2b.apellido,
    pa.created_at
  from partidos pa
